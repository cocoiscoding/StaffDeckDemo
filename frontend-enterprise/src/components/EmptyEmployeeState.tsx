/**
 * @file EmptyEmployeeState.tsx
 * @module components/EmptyEmployeeState
 * @description 数字员工空状态组件。当用户还没有任何数字员工时展示引导界面，
 *              提供"新建数字员工"和"浏览开放广场"两个入口按钮。
 */
...
/**
 * 数字员工空状态组件。根据用户角色（管理员/普通用户）显示不同的引导文案，
 * 并提供新建数字员工和浏览开放广场的操作入口。
 *
 * @param props - 组件属性
 * @param props.isAdmin - 是否为管理员
 * @param props.onCreate - 新建数字员工回调
 * @param props.onBrowsePlatform - 浏览开放广场回调
 * @returns 渲染好的空状态引导界面
 */
