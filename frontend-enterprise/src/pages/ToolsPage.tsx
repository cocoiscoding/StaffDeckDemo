/**
 * @file ToolsPage.tsx
 * @module pages/ToolsPage
 * @description 工具管理页面。展示 HTTP 工具和 MCP 服务器（工具集）的列表、统计、搜索筛选，
 *              支持新建/编辑/测试 HTTP 工具、连接并同步 MCP Server 工具集、
 *              从广场或数字员工复制工具等操作。包含工具编辑器、MCP 编辑器、测试页等子组件。
 */
