 ...
 * @description 企业端登录页面。
 *
 * 首屏展示品牌 Logo、产品标题和产品预览图，点击"登录"按钮后
 * 在原位展开账号密码输入表单。支持密码可见切换、回车提交、
 * 清空输入和字段级错误提示。登录成功后将认证会话回传给父级。
 */
 ...
 */
/**
 * 登录页面主组件。管理表单展开状态、账号密码输入、密码可见切换、
 * 登录请求与错误提示。
 *
 * @param props - 组件属性
 * @param props.onLogin - 登录成功回调，传入认证会话
 * @returns 渲染好的登录页面
 */
