/**
 * @file GeneralSkillsPage.tsx
 * @module pages/GeneralSkillsPage
 * @description 通用技能（Skills）管理页面。展示技能列表、搜索筛选、统计概览，
 *              支持新建/编辑/启用/停用/删除技能、从 GitHub 导入、从广场或数字员工复制等操作。
 *              技能用于扩展数字员工的能力范围。
 */
 ...
 *
 * @param props - 组件属性
 * @param props.embedded - 是否以嵌入模式运行（隐藏页面外壳）
