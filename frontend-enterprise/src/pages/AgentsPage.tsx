 ...
 * @description 数字员工管理页面。展示员工卡片网格、统计概览、搜索筛选，
 *              提供创建、编辑、删除、上下线、广场发布、头像设置、发起对话等操作。
 *              员工卡片以卡片形式展示头像、名称、岗位、状态、描述和资源统计。
 */
...
export default function AgentsPage({
  ...
  /**
   * 更新员工的广场发布状态。
   * 设置 metadata 中的 published_to_gallery 等字段后调用后端保存，
   * 并广播作用域刷新事件。
   * @param row - 目标员工数据
   * @param published - true 为发布到广场，false 为从广场下架
   */
